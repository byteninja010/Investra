...
class CritiqueResult(BaseModel):
    ...
    needs_reanalysis: bool = Field(default=False, description="Whether re-analysis is needed")
    reanalysis_instructions: str = Field(default="", description="Instructions for re-analysis if required")
